...
def test_certificates_available_succeeds(harness):
    ...
    harness.charm.unit.add_secret({"csr": "not-missing"}, label="zookeeper-k8s.unit")
    ...
    secret = harness.charm.model.get_secret(label="zookeeper-k8s.unit")
